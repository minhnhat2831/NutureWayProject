...
import { isAgeGreaterThan18, isStrongPassword } from '@/utils/validation'
...
//Stage 4
export const checkPasswordSchema = registerRequestSchema.pick({
    password : true,
...
//Stage 5
export const registerDetailSchema = registerRequestSchema.pick({
    firstName: true,
    middleName: true,
    lastName: true,
    birthDate: true,

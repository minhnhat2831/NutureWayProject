    ...
    return (<>
        <div className="h-screen bg-white">
            ...
            {!value && <>
                ...
                <h1 className="font-serif italic">Search history<span className="font-serif text-gray-400"> 5</span></h1>
            ...
            <div className="px-4 py-2">
                <h1 className="font-serif italic">Recommended doulas<span className="font-serif text-gray-400"> 5</span></h1>
                <div>

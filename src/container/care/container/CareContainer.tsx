...
export default function CareContainer() {
    ...
    return (<>
        <div className="h-screen bg-white">
            <Header title="My care" iconR1={<Icons.calendarIcon />} onClickIconR1={() => nav('/home/care/appointment')} />
                ...
                <div className="flex flex-col gap-4 px-2">
                    {CARES_ONGOING.map((care, index) => (
                        <ComponentCard
                            ...
                            showExpandRight
                            onClick={() => nav(`/home/care/${index}`, { state : { title : care.title, subTitle : care.subTitle }})}
                        />
                    ))}
                </div>
            </>}
